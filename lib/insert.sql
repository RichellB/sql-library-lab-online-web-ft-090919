INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, "Waking Dead", 1, 1), (2, "Goodbye Friend", 2, 2);

INSERT INTO subgenres (id, name) VALUES (1, "Fiction"), (2, "Nonfiction");

INSERT INTO authors (id, name) VALUES (1, "Matthew Collin"), (2, "Ruby Vane");

INSERT INTO books (id, title, year, series_id) VALUES (1, "Hello to the End", 2007, 1), (2, "Goodbye to the World We Knew", 2008, 1), (3, "Bestfriends", 2018, 2), (4, "Jam", 2019, 1), (5, "You and I", 2003, 2), (6, "Lovers Forever", 2011, 2);
